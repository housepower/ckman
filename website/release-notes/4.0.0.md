...
> 📸 待补封面 · `cover-4.0.0.png` — 建议放一张 CKMAN 4.0 主界面 + "4.0.0" 字样的视觉图
...
> 📸 待补截图 · `nacos-hot-reload.png` — Nacos 控制台改配置 → ckman 日志中显示 OnChange 触发链路
...
> 📸 待补尾图 · `footer-qrcode.png` — 公众号二维码 / 项目二维码
