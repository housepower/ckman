...
> 📸 待补截图 · `user-mgmt-create.png` — 新建用户弹窗（待补：UI 「设置 → 用户管理 → 新增用户」）
...
> 📸 待补截图 · `node-override-dialog.png` — 单节点 override 弹窗（XML 编辑器 + XPath 路径预览）
...
> 📸 待补截图 · `ckmanctl-sql-repl.gif` — REPL 交互演示
...
> 📸 待补截图 · `rebalance-plan-preview.png` — Rebalance Plan 预览向导（待补：集群操作 → Rebalance → 预览）
...
> 📸 待补截图 · `docs-vitepress-home.png` — 文档站首页
>
> 📸 待补截图 · `download-page.png` — 下载页（含 4.0.0 release notes 内嵌）
