...
<!-- TODO(screenshot): 当前为占位图，请用实际截图替换 /img/features/tables/metrics.png（Table Metrics 列表） -->
...
<!-- TODO(screenshot): 当前为占位图，请用实际截图替换 /img/features/tables/replication.png（副本对齐情况） -->
...
<!-- TODO(screenshot): 当前为占位图，请用实际截图替换 /img/features/tables/zk-status.png（ZK 状态） -->
...
<!-- TODO(screenshot): 当前为占位图，请用实际截图替换 /img/features/tables/open-sessions.png（会话列表 + kill 按钮） -->
...
<!-- TODO(screenshot): 当前为占位图，请用实际截图替换 /img/features/tables/slow-sessions.png（慢查询列表） -->
