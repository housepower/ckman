...
var doc = `{
    ...
    "paths": {
        ...
        "/api/v1/ck/backgroundpool/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/ddl_queue/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/node/override/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\":\"0000\",\"msg\":\"ok\",\"data\":{\"ip\":\"...\",\"xml\":\"...\"}}",
                        "schema": {
                            "type": "string"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.NodeOverrideReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"code\":\"0000\",\"msg\":\"ok\",\"data\":{\"reloaded\":true}}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/ck/partition/operate/{clusterName}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/query_export/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/rebalance_info/{clusterName}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\":\"5000\",\"msg\":\"invalid params\",\"data\":\"\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/ck/rebalance_plan/{clusterName}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/table/dml/{clusterName}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/table/migrate/{clusterName}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.MigrateTableReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/ck/table/readonly/{clusterName}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/ck/table_merges/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/metric/query-range/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/metric/query_metric/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ChangeMyPasswordReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/zk/replicated_queue/{clusterName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\":\"5080\",\"msg\":\"get zk queue fail\",\"data\":null}",
                        "schema": {
                            "type": "string"
                        }
                    }
