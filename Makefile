...
backend:
	...
	CGO_ENABLED=0 go build ${LDFLAGS} -o cmd/ckman-watchdog/ckman-watchdog cmd/ckman-watchdog/ckman-watchdog.go
...
package:build
	...
	@mv ${SHDIR}/cmd/ckman-watchdog/ckman-watchdog ${PKGFULLDIR_TMP}/bin
