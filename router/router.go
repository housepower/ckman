...
func InitRouterV1(groupV1 *gin.RouterGroup, config *config.CKManConfig, prom *prometheus.PrometheusService,
	...
	groupV1.POST("/ck/dist_table", ckController.CreateDistTableOnLogic)
	...
	groupV1.GET(fmt.Sprintf("/ck/table_schemer/:%s", controller.ClickHouseClusterPath), ckController.ShowSchemer)
